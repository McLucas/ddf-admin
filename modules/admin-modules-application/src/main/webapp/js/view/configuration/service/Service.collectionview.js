...
define([
    ...
    '/applications/js/view/configuration/service/Service.itemview.js'
],function (ich, _, Marionette, Service, ConfigurationEdit,serviceList, ServiceItemView) {
    ...
    var ServiceCollection = Marionette.CompositeView.extend({
